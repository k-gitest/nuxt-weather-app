          ...
          <div class="areaMapSVG_wrap">
            <div class="areaMapSVG">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 350 293.53" overflow="visible">
                ...
                <a xlink:href="#" v-show="areaTab === 0 || areaTab === 1" @click="map_area(centers['010200'].children);areaTab = 1">
                ...
                <a xlink:href="#" v-show="areaTab === 0 || areaTab === 7">
                  <g class="shikoku" :class="{shikoku_zoom: areaTab === 7}" @click="map_area(centers['010800'].children);areaTab = 7">
                      <path 
                ...
                <a xlink:href="#" v-show="areaTab === 0 || areaTab === 8">
                  <g class="kyusyu" :class="{kyusyu_zoom: areaTab === 8}" @click="map_area(centers['010900'].children);areaTab = 8">
                      <path 
                ...
                <a xlink:href="#" v-show="areaTab === 0 || areaTab === 9">
                  <g class="okinawa" :class="{okinawa_zoom: areaTab === 9}" @click="map_area(centers['011100'].children);areaTab = 9">
                      <path
                ...
                <a xlink:href="#" v-show="areaTab === 0 || areaTab === 6">
                  <g class="chugoku" :class="{chugoku_zoom: areaTab === 6}" @click="map_area(centers['010700'].children);areaTab = 6">
                      <path
                ...
                <a xlink:href="#" v-show="areaTab === 0 || areaTab === 5">
                  <g class="kansai" :class="{kansai_zoom: areaTab === 5}" @click="map_area(centers['010600'].children);areaTab = 5">
                      <path
                ...
                <a xlink:href="#" v-show="areaTab === 0 || areaTab === 4" @click="map_area(centers['010400'].children);areaTab = 4">
                  <g class="tokai" :class="{tokai_zoom: areaTab === 4}">
                      <path
                ...
                <a xlink:href="#" v-show="areaTab === 0 || areaTab === 3" @click="map_area(centers['010300'].children);areaTab = 3">
                  <g class="kanto" :class="{kanto_zoom: areaTab === 3}">
                      <path
                ...
                <a xlink:href="#" v-show="areaTab === 0 || areaTab === 2" @click="map_area(centers['010200'].children);areaTab = 2">
                  <g class="tohoku" :class="{tohoku_zoom: areaTab === 2}">
                      <path
